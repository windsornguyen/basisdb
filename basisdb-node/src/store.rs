//! Durable Raft state over the BasisDB WAL.
//!
...
use basisdb_raft::raft::{Entry, Persistent};
use basisdb_raft::{LogIndex, NodeId};
use basisdb_wal::{RecordKind, Wal, WalError, WalOptions};
...
struct PersistentDelta {
    ...
    bootstrap_config: basisdb_raft::Configuration,
